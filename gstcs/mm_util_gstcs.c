...
_mm_check_resize_format_label(char* __format_label)
{
	...
	if(strcmp(__format_label, "AYUV") == 0
		...
		||strcmp(__format_label, "Y42B") == 0 ||strcmp(__format_label, "YUY2") == 0 ||strcmp(__format_label, "YUYV") == 0 
		||strcmp(__format_label, "Y41B") == 0 ||strcmp(__format_label, "Y16") == 0 ||strcmp(__format_label, "Y8") == 0
